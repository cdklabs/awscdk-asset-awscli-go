...
import (
	...
	_init_ "github.com/cdklabs/awscdk-asset-awscli-go/awscliv2/v2/jsii"
	...
	"github.com/cdklabs/awscdk-asset-awscli-go/awscliv2/v2/internal"
)
...
func NewAwsCliAsset(scope constructs.Construct, id *string, options *awss3assets.AssetOptions) AwsCliAsset {
	...
	_jsii_.Create(
		"@aws-cdk/asset-awscli-v2.AwsCliAsset",
...
func (a *jsiiProxy_AwsCliAsset) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
